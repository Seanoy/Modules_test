...
/**
  * @brief  Configures IIC's NVIC and Vector Table base location.
  * @param  None
  * @retval : None
  */
void NVIC_IIC_Configuration(void)
{
...
/**
  * @brief  Configures IIC(1&2)'s GPIO.
  * @param  None
  * @retval : None
  */
...
IIC2	SDA-PB11			SCL-PB10
都将其设置为开漏输出
*/
void GPIO_IIC_Configuration(void)
{
	GPIO_InitTypeDef  GPIO_InitStructure; 
  RCC_APB2PeriphClockCmd( RCC_APB2Periph_GPIOB , ENABLE);	
